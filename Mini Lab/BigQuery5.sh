...
function random_congrats() {
    MESSAGES=(
        ...
        "${MAGENTA}Great work! You’re one step closer to maining this!${RESET}"
        ...
        "${GREEN}Well done! This is a big step towards maining the topic!${RESET}"
        ...
        "${YELLOW}Excellent execution! You’re well on your way to maining the subject!${RESET}"
        ...
        "${YELLOW}Great execution! You’re truly maining this!${RESET}"
