...
```
curl -LO raw.githubusercontent.com/AnniiGCP/Google-Cloud-Arcade/main/Get%20Started%20with%20PubSub%20Challenge%20Lab/form_1.sh
...
### For form 2: Solution [here] w-bnVtz2dWY)
---
...
```
```
curl -LO raw.githubusercontent.com/AnniiGCP/Google-Cloud-Arcade/main/Get%20Started%20with%20PubSub%20Challenge%20Lab/form_2.sh
...
### For form 3: Solution [here] SZdTvD5Cfig)
---
...
```
```
curl -LO raw.githubusercontent.com/AnniiGCP/Google-Cloud-Arcade/main/Get%20Started%20with%20PubSub%20Challenge%20Lab/form_3.sh
